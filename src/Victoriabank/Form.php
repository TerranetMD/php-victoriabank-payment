...
class Form{
     ...
     * @return $this
     */
    public function addTextElement($elementName, $elementValue='', $elementOptions=array())
    {
     ...
     * @return $this
     */
    public function addHiddenElement($elementName, $elementValue='', $elementOptions=array())
    {
    ...
    public function renderForm($autoSubmit=true)
    {
        ...
        if (!$autoSubmit)
            $html  .= $this->_renderElement(self::ELEMENT_BUTTON, 'btnSubmit', 'Send', array('id'=>$this->_formName . '-submit', 'onclick'=>"document.getElementById('{$this->_formName}-form').submit();")) . "<br/>\n";
